...
function findJokesNumberById(id) {
...
app.get("/jokes/:id", (req, res) => {
  ...
  res.json(jokes[findJokesNumberById(id)]);
});
...
app.put("/jokes/:id", (req, res) => {
  ...
  jokes[findJokesNumberById(id)] = updatedJoke;
...
app.patch("/jokes/:id", (req, res) => {
  ...
  if (req.body.text) {
    jokes[findJokesNumberById(id)].jokeText = req.body.text;
  }
  if (req.body.type) {
    jokes[findJokesNumberById(id)].jokeType = req.body.type;
  }

  const updatedJoke = jokes[findJokesNumberById(id)];
...
app.delete("/jokes/:id", (req, res) => {
  ...
  jokes.splice(findJokesNumberById(id), 1);
  res.sendStatus(200);
});
